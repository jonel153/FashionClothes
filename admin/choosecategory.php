	...
	<div id="container">
		...
		<div class="content">
			...
			<div id="box">
				...
				<div class="box-panel">
					<div id="info"><strong>Step 1:</strong>Add Category</div>
					<hr class="colorgraph">

					<form enctype="multipart/form-data" id="reg" action="choosesubcategory.php" method="POST" class="form-vertical">
						<div id="divcategory">
							<div class="form-group">
								<div class="col-xs-7">
									...
									<?php
										...
										$result = mysql_query("SELECT * FROM categorytbl");
								...
								<div id="textboxcategory">
									<div class="form-group">
										<div class="col-xs-2">
											<a href="addnewcategory.php" class="btn btn-default">New category</a>	
										</div>	
									</div>
								</div>
							</div>
